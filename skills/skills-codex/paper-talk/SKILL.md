...
6. **Fresh-context independence.** Per-page Codex calls in `/slides-polish` use fresh `spawn_agent` calls (no `followup_task`) and are same-family provisional in the base mirror.
